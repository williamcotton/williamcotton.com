...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <p>Copyright law in the United States has changed drastically since the late 18th century. The terms have ballooned and there is now an explicit difference between individual authorship and corporate authorship. Individuals are now granted a lifetime term plus an additional 70 years before their property reverts to the public domain. Corporations are granted a 120 year term after creation or 95 years after publication. These changes are clearly detrimental to both the public commons as well as individual authors, as the changes primarily favor corporations. In the 1970s, the Library was so overwhelmed that it abdicated its position as central registry. Registration with the Library was supplanted as the basis of ownership by the concept of Proof of Publication – to be determined by the courts once a claim to infringement has been opened. This, however, is costly beyond the resources of your typical culture-producing individual.</p>
      ...
      <p>There's no reason why <b>existing industries</b>  – such as the Music Industry with its organizations like ASCAP, BMI and SESAC, SoundExchange, and TuneCore – couldn't <b>embrace these new financial technologies</b> like Open Publish and <b>provide new market opportunities</b> for their clients, while still continuing to do business with Spotify, Google, Facebook and Apple, as well as Universal, Sony, and Warner Bros. There's no reason for Universal, Sony and Warner Bros not to explore possible new marketplaces built on Open Publish for their existing intellectual property. There's no reason for companies like Spotify, Kickstarter, Patreon, Google, Facebook and Apple not to use Open Publish to <b>facilitate in equal-access revenue sharing</b>. With Web 2016 we're all in the business of producing, selling, and consuming ideas and <b>we all stand to benefit from free and open commerce</b>, corporations and individuals alike, but only <b>if we all embrace author-centric notions of intellectual property</b>.</p>
      ...
      <p>Blockai is our commercial product, and we would love to serve you in your needs for <b>registering your digital media with Open Publish</b>! This is just the first step in a process to build a unified public marketplace for digital media. It obviously needs <b>community support</b> and network effects in order to succeed.</p>
