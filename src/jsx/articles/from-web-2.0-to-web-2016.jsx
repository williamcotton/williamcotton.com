...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <p>Blockai and Open Publish posit that <b>our future is bright and we see a lot of room for continued innovation</b> in the creation, distribution and professional production of digital media. We just need to embrace our already existing notions of financial capital and apply them to the Web. The problem isn't with the commercial nature of the Web, it's with an ineffifient market mechanism for open and free marketplaces for intellectual property.</p>
