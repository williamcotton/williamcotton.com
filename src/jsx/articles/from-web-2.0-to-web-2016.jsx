...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <p>Blockai is our commerical product, and we would love to serve you in your needs for registering your digital media with Open Publish! We're making a public marketplace that needs community support and network effects in order to succeed.</p>
