...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <p>There's also a danger that this pessimism could turn people against decentralized and democratic models of production with a return of language related to uneven relationships between consumers, producers and financiers.</p>

      <p>Blockai and Open Publish posit that <b>our future is bright and we see a lot of room for continued innovation</b> in the creation, distribution and professional production of digital media, from film, music and long-form articles to new digital artforms like gifs, games and memes. We want to ensure for the Web a voluntary and decentralized solution for copyright. We want to make sure that the egalitarian and public access nature of the Web remains healthy and intact. That's why we built Open Publish. </p>

      <p>Open Publish is an open source and equal-access copyright registrations and digital rights management system built on top of the Bitcoin blockchain. Our commercial Blockai product is built directly on top of Open Publish, which allows us to maintain an unprivilidged position, guarenteeing a fundamentally open and public system. If we go out of business, the blockchain remains, along with all of your claims of ownership. For more details, please check out the <a href='https://github.com/blockai/openpublish'>Open Publish</a> and <a href='https://github.com/blockai/openpublish-state-engine'>Open Publish State Engine</a> repositories on GitHub.</p>
      ...
      <i> I've spent most of the past year building software that will enable users to register their digital products in the Bitcoin blockchain, so that they can attain permanant, unambiguous and distributed proof of ownership of their intellectual property. We are calling this tool Open Publish. It works. And it is only the first in a series of products we will release that will allow you to X, Y, Z </i> 
