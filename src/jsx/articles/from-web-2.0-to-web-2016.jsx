...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <p>Everyone should embrace the spirit of optimism in our continued appreciation and support of Web 2.0 methods of cultural production. Wikipedia, Archive.org, Patreon, Kickstarter and many other services are bearing wondering fruits and I expect these to continue.</p>
      ...
      <p>It is hardly fair to call the media landscape of Web 2016 a sort of Feudalism, even though analogies to content farms are apt. Feudalism implied a lack of choice on behalf of the participants. Just as No One Force You To Shop at Wal-Mart, no one forces you to use Facebook.</p>
      ...
      <p>We really can do so much more. Kickstarter, IndieGogo, Patreon and a number of other Web 2.0 companies have shown the way forward for decentralized financing of commercial digital media production. We need to retain the fan support but add a notion of asset ownership. This will allow for Kickstarter and Patreon-like systems that support dedicated support networks of publishers and labels. Fans could possibly share in the financial growth of their favorite authors and artists.</p>
      ...
      <p>We need people to build open platform versions of Spotify that use Open Publish. We need to build open platform versions of Kickstarter and Patreon that use Open Publish. By using Open Publish to bind the contracts between audiences on Spotify-like systems and fans and investors on Kickstarter-like systems, we can create amazing new ways to create and to share! Web 2016 is the realization that we need to share in each other's wealth, not just in each other's ideas.</p>

      <p>There's no reason why existing industries with organizations like ASCAP, BMI and SESAC, SoundExchange, and TuneCore couldn't embrace these new financial technologies like Open Publish and provide new market oppurtunities for their clients, while still continuing to do business with Spotify, Google, Facebook and Apple, as well as Universal, Sony, and Warners. There's no reason for Universal, Sony and Warners not to explore possible new marketplaces built on Open Publish for their existing intellectual property. There's no reason for companies like Spotify, Google, Facebook and Apple not to use Open Publish to facilitate in equal-access revenue sharing. We're all in the business of producing, selling, and consuming ideas and we all stand to benefit from free and open commerce.</p>

      <p>Blockai is our commerical product, and we would love to serve you in your needs for registering your digital media with Open Publish! We're setting out to build a public marketplace that needs community support and network effects in order to succeed.</p>

      <p>The first and most important feature is being able to register your work. This gets you immutable proof of publishing by embedding a unique digital media fingerprint in the Bitcoin blockchain signed by a Bitcoin wallet associated with your identity. Think of it like getting a document signed, dated, numbered and notorized. Your registration creates a digital certificate on Blockai's website that you can use as proof for any cases of IP infringement. We're looking to explore a number of other features, like allowing for you to sell licenses for private and commercial use, interfacing with existing digital media marketplaces, and tracking usage and reach. The first step is building up a large centralized repository of individually owned and controlled digital asset registrations.</p>
