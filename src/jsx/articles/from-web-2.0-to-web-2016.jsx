...
class IntroToExpect extends React.Component {
  render () {
    return <Article title='From Web 2.0 to Web 2016' >
      ...
      <ol>
        <li>Folksonomy is replaced by <b>third-party editorial algorithms</b>. Professional editorialism never went away. We're still tuning in to Fox News, ESPN, and Chelsea Handler and reading them online, even if they are now using information technology to assist in the editorial process. Facebook uses algorithmic filters to provide a better experience.</li>
        ...
        <li>Software as a service turned in to <b>restricted API access</b>. Twitter has long since abandoned the grass roots network of clients and has added many restrictions to it's API. Subscription data services never went away. Bloomberg continues to sell professional terminals, and Getty continues to sell professional photographs.</li>
      ...
      <p>This is not a criticism of Web 2.0 nor the <b>wonderful new modes of production</b> that were introduced. Whereas previous critique of Web 2.0 has focused on the aesthetic and moral values of cultural production, with works like <a href='https://en.wikipedia.org/wiki/The_Cult_of_the_Amateur'>The Cult of the Amateur</a> by Andrew Keen, contemporary critique of the Web 2016 modes of production are financial and political in nature, like <a href='https://en.wikipedia.org/wiki/The_People%27s_Platform:_Taking_Back_Power_and_Culture_in_the_Digital_Age'>The People's Platform</a> by Astra Taylor. These critiques reflects the dynamic shift from the aesthetic and moral conditions of Web 2.0 to the financial and political conditions of Web 2016.</p>

      <p>Everyone should embrace the spirit of optimism in our continued appreciation and support of Web 2.0 methods of cultural production. Wikipedia, Archive.org, Patreon, Kickstarter and many other services are bearing wondering fruits and I expect these to continue. Web 2.0 never went away, but the sublte difference is, Hollywood never went away either!</p>

      <p>Netflix, Amazon and Apple are continuing to finance what many are calling the <a href='https://en.wikipedia.org/wiki/Golden_Age_of_Television_(2000s%E2%80%93present)'>Golden Age of Television</a>. These are big budget creations made by a pre-existing and historical mode of cultural production. The Hollywood Studio system, it's Guilds and complex and opaque system of accounting, remain fully functional. Financing the creation and distribution of Copyrighted Works and other forms of intellectual property are important parts of what keeps their industries produtive and functional, even as they deal with the weight of collective bargaining and stardom. Everyone should embrace the spirit of optimism in our continued appreciation for professional cultural productions. Everyone should also read <a href='http://www.amazon.com/gp/product/0674001885?ie=UTF8&tag=marginalrevol-20&linkCode=as2&camp=1789&creative=9325&creativeASIN=0674001885'>In Praise of Commercial Culture</a>.</p>

      <p>It is hardly fair to call the media landscape of Web 2016 a sort of Feudalism, even though analogies to content farms are apt. Feudalism implied a lack of choice on behalf of the participants. Just as No One Force You To Shop at Wal-Mart, no one forces you to use Facebook. For those either on the inside or outside of Web 2016 who yearn for the optimism of our very recent past, the future is starting to look pretty grim.</p>

      <p>There's a danger that this pessimism could turn people further against Copyright as they point the blame at the very notion of digital property. Blockai and Open Publish want to make sure that the corporate abuses that we associate with 20th century Copyright belie the underlying protections to digital liberty that we sometimes may take for granted.</p>
      ...
      <p>Blockai and Open Publish posit that <b>our future is bright and we see a lot of room for continued innovation</b> in the creation, distribution and professional production of digital media. We just need to embrace our already existing notions of capital and apply them to the Web. The problem isn't with the commercial nature of the Web, it's with an ineffifient market mechanism for open and free marketplaces for intellectual property.</p>

      <p>We really can do so much more. Kickstarter, IndieGogo, Patreon and a number of other Web 2.0 companies have shown the way forward for <b>decentralized financing of commercial digital media production</b>. We need to retain the fan support but add a notion of <b>asset ownership</b>. This will allow for Kickstarter and Patreon-like systems that support dedicated support networks of publishers and labels. Fans could possibly <b>share in the financial growth</b> of their favorite authors and artists!</p>
      ...
      <p>The first and most important feature is being able to <b>register your work</b>. This gets you immutable proof of publishing by embedding a unique digital media fingerprint in the Bitcoin blockchain signed by a Bitcoin wallet associated with your identity. Think of it like getting a document signed, dated, numbered and notorized. Your registration creates a <b>digital certificate</b> on Blockai's website that you can use as proof for any cases of IP infringement. We're looking to explore a number of other features, like allowing for you to sell licenses for private and commercial use, interfacing with existing digital media marketplaces, and tracking usage and reach. The first step is building up a large centralized repository of individually owned and controlled digital asset registrations.</p>

      <p>You can of course use Open Pubish to create your own registration services. Keep in mind that Open Publish is powered by Bitcoin so you'll need to purchase some and look after your own wallet. There's no such thing as a free lunch! As long as Bitcoin or any other cryptocurrencies continue to function, Open Publish will retain the underlying public and equal-access consensus making machinery of the blockchain, allowing for a stable, open, public and completely transparent system of private ownership over digital assets.</p>
    </Article>
  }
}
