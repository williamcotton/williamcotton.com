...
class HowOpenPublishCanReleaseTheDormantValueOfDigitalCulturalProduction extends React.Component {
  render () {
    return <Article title='How Open Publish Can Release the Dormant Value of Digital Cultural Production' >
      ...
      <p><i>(2) Integrating dispersed information into one system.</i> Open Publish registrations and transactions are embedded in a shared, singular and public data store. There is a <b>single consensus, maintained in a decentralized manner</b>, built directly into the mechanics of the Bitcoin blockchain. With this unified formal property system "where property information is standardized and universally available, what owners can do with their assets benefits from the collective imagination of a larger network of people."</p>

      <p><i>(3) Making people accountable.</i> Open Publish transactions and registrations are fully accountable. All transactions aim to be public to give a true market value to Open Publish registered media. "By transforming people with real property interests into accountable individuals, formal property [creates] individuals from masses." <b>The individual is then held accountable for their ownership</b>. They maintain their own Bitcoin wallet private keys, or at least choose to work with someone who maintains their private keys on their behalf. They are then free to be fully autonomous as Open Publish is not controlled by any private entity and can then "explore how to generate surplus value from their own assets".</p>

      <p><i>(4) Making assets fungible.</i> Open Publish allows for the ownership of digital media assets to be transfered in whole or divided in to parts. By default an Open Publish asset is given 100,000,000 units, allowing for individuals <b>to split "their assets into shares, each of which can be owned by different persons</b>, with different rights, to carry out different functions." This enables "owners and entrepreneurs to simulate hypothetical situations in order to explore other profitable uses of their assets."</p>

      <p><i>(5) Networking people.</i> Open Publish is built directly on top of native Bitcoin transactions, which are propagated across the entire network and embedded in each copy of a shared ledger. This <b>allows for anyone to participate</b> in both the Bitcoin and the Open Publish network <b>without permission</b>. All of the "information on the history of assets and owners [is] easily accessible" on both the Bitcoin blockchain and the Open Publish registry. This allows for "radically improved ... flow of communications about assets and their potential", at least compared with current copyright systems and opaque marketplaces for digital media assets like Facebook or Twitter.</p>

      <p><i>(6) Protecting transactions.</i> Open Publish registrations and transactions inherit all of the protections and security of the Bitcoin Blockchain. When a Bitcoin transaction is mined it is <b>protected by a cryptographic system that is incredibly secure</b>. "Security is principally focused on producing trust in transactions so that people can more easily make their assets lead a parallel life as capital."</p>
