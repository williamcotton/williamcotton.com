...
class About extends React.Component {
  render () {
    return <div className='about-container'>
      <h1>About</h1>
      <p>All the articles are React components. They're committed to Git. They stay versioned, with a full history. This website is a <a href='https://github.com/williamcotton/williamcotton.com'>public Git repository hosted on GitHub</a>.</p>
